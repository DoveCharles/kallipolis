...
import { loudnessOf, muffler } from './voices.js';
...
const REF_DISTANCE = 5, HEAR_DISTANCE = 40; // (as for babble)
...
export function sayLine(at, voice, who, mood = 0) {
  ...
  const source = playBufferAt(buffer, at, rms ? MATCH*loudnessOf(voice)/rms : 0, REF_DISTANCE, HEAR_DISTANCE, 1, [muffler(at)]);
