...
export async function loadCarriageModel() {
  ...
  try {
    ...
    console.warn('Kallipolis: the carriage model failed to load; train carriages use the built-in capsule', err);
    return;
  }
  ...
  }, (err) => console.warn('Kallipolis: the carriage model failed to load; train carriages use the built-in capsule', err));
}
...
const NODE_UI_DISTANCE = IS_TOUCH ? 136 : 198;
